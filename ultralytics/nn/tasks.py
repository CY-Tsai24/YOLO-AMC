...
from ultralytics.nn.modules import (
    ...
    AKConv,
    DSConv,
    GAM_Attention,GCT,ShuffleAttention,ResBlock_CBAM,ECAAttention,MHSA,GatherExcite,GlobalContext,ResBlock_CBAM_NoResidual
)
...
class BaseModel(nn.Module):
    ...
    # def _predict_once(self, x, profile=False, visualize=False, embed=None, log_file="./layers_log.txt"):
    #     """
    #     Perform a forward pass through the network and save module info to a log file.
    #     """
    #     y, dt, embeddings = [], [], []  # outputs
        
    #     # 打開檔案（append 模式，不會覆蓋原有內容）
